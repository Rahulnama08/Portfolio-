  ...
  return (
    <div className="isolate px-6 py-24 sm:py-32 lg:px-8 bg-[#171d33]">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balanc sm:text-5xl col text-white">Contact Us</h2>
        <p className="mt-2 text-lg/8 text-white">Let's build something amazing together! Fill out the form, and I'll be in touch shortly.</p>
      </div>
